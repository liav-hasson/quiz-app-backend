...
VALID_STYLE_MODIFIERS = ['concept explanation', 'use case scenario', 'troubleshooting', 'comparison']
...
mock_quiz_controller.get_style_modifiers_by_topic_subtopic.side_effect = lambda t, s: VALID_STYLE_MODIFIERS if t in VALID_TOPICS and s in VALID_SUBTOPICS else []
